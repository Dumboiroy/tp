...
public abstract class LinkAppointmentCommand extends Command {
    ...
    public static final String MESSAGE_CLASH_APPOINTMENTS_CREATE = "Two confirmed appointments clash.\n[old: %s] %s\n[new] %s";
    public static final String MESSAGE_CLASH_APPOINTMENTS_EDIT = "Two confirmed appointments clash. \n[old: %s] %s\n[new: %s] %s";
